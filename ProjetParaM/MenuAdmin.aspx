<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenuAdmin.aspx.cs" Inherits="ProjetParaM.MenuAdmin" %>
...
&nbsp;&nbsp;&nbsp;
                        ...
                        <td colspan="3" style="border-bottom-style: solid; border-bottom-width: 5px; border-bottom-color: #333333;">
                                    <asp:Menu ID="Menu2" runat="server" BorderColor="White" Font-Italic="False" Font-Size="XX-Large" Font-Strikeout="False" ForeColor="White" Orientation="Horizontal" BackColor="#009999" Width="100%"  Font-Bold="True" RenderingMode="List">
                                        ...
                                        <Items>
                                            ...
                                            <asp:MenuItem Text="Liste des utilsateurs" Value="Bio" NavigateUrl="~/ListeUser.aspx"></asp:MenuItem>
                                            <asp:MenuItem Text="Liste Produits" Value="Bébé" NavigateUrl="~/ListeProduits.aspx"></asp:MenuItem>
                                            <asp:MenuItem Text="Liste Produits Acheter" Value="Médicament" NavigateUrl="~/ListAchat.aspx"></asp:MenuItem>
        ...
        <tr>
            <td class="auto-style17" style="width:33%">
                <br />
                QUI SOMME NOUS ST TEST TEST TSESTSGSGGSGSGSG<br />
