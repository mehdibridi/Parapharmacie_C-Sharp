<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenuClient.aspx.cs" Inherits="ProjetParaM.MenuClient" %>
                        ...
                        <td colspan="3" style="border-bottom-style: solid; border-bottom-width: 5px; border-bottom-color: #333333;">
                                    <asp:Menu ID="Menu2" runat="server" BorderColor="White" Font-Italic="False" Font-Size="XX-Large" Font-Strikeout="False" ForeColor="White" Orientation="Horizontal" BackColor="#009999" Width="100%"  Font-Bold="True" RenderingMode="List">
                                        ...
                                        <Items>
                                            ...
                                            <asp:MenuItem Text="Bio" Value="Bio" NavigateUrl="~/MedicamentList.aspx"></asp:MenuItem>
                                            <asp:MenuItem Text="Bébé" Value="Bébé" NavigateUrl="~/MedicamentList.aspx"></asp:MenuItem>
                                            <asp:MenuItem Text="Médicament" Value="Médicament" NavigateUrl="~/MedicamentList.aspx"></asp:MenuItem>
                                            <asp:MenuItem Text="Santé" Value="Santé" NavigateUrl="~/MedicamentList.aspx"></asp:MenuItem>
                                            <asp:MenuItem Text="Visage" Value="Visage" NavigateUrl="~/MedicamentList.aspx"></asp:MenuItem>
